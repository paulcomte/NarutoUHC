...
public class ViewInventory extends RInventory {
    ...
    public ViewInventory(Setup setup, Player target, GamePlayer gamePlayer) {
        ...
        this.setItem(45, new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner(target.getName()).setName(ChatColor.GREEN + "Pseudo: " + ChatColor.YELLOW + "" + target.getName()).setLore(ChatColor.GOLD + "Mort: " + (gamePlayer.isDead ? ChatColor.GREEN + "Oui" : ChatColor.RED + "Non")).toItemStack());
